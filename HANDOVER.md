  ...
  sections: [
    ...
    },
    {
      ...
      children: [
        ...
        { id: 'card2', archetype: 'container', behavior: 'cellFit', cell: 1,
          x: 16, y: 48, w: 384, h: 280,
          props: { background: '#FFFFFF', borderColor: '#E4E4E7', borderRadius: 12 } },
        { archetype: 'text', behavior: 'cellFit', parent: 'card2',
          x: 24, y: 24, w: 336, h: 32,
        ...
        { id: 'card3', archetype: 'container', behavior: 'cellFit', cell: 2,
          x: 16, y: 48, w: 384, h: 280,
          props: { background: '#FFFFFF', borderColor: '#E4E4E7', borderRadius: 12 } },
        { archetype: 'text', behavior: 'cellFit', parent: 'card3',
          x: 24, y: 24, w: 336, h: 32,
