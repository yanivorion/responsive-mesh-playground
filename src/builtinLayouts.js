...
const LAYOUT_09 = {
  ...
  sections: [
    ...
    },
    {
      ...
      children: [
        { id: 'split-left', archetype: 'container', behavior: 'stretch', cell: 0, x: 0, y: 0, w: 0, h: 0,
          props: { background: '#F4F4F5', borderColor: 'transparent', borderRadius: 0 } },
...
const LAYOUT_006 = {
  ...
  sections: [
    ...
    { behavior: 'fixedHeight', height: 360, layout: '3col', children: [
      { id: 'tu-c1', archetype: 'container', behavior: 'stretch', cell: 0, x: 0, y: 0, w: 0, h: 0,
        props: { background: '#F4F4F5', borderColor: 'transparent', borderRadius: 0 } },
      ...
      { id: 'tu-c2', archetype: 'container', behavior: 'stretch', cell: 1, x: 0, y: 0, w: 0, h: 0,
      ...
      { id: 'tu-c3', archetype: 'container', behavior: 'stretch', cell: 2, x: 0, y: 0, w: 0, h: 0,
        props: { background: '#F4F4F5', borderColor: 'transparent', borderRadius: 0 } },
...
const LAYOUT_008 = {
  ...
  sections: [
    ...
    { behavior: 'fixedHeight', height: 480, layout: '3col', children: [
      { id: 'pr-c1', archetype: 'container', behavior: 'stretch', cell: 0, x: 0, y: 0, w: 0, h: 0,
      ...
      { id: 'pr-c2', archetype: 'container', behavior: 'stretch', cell: 1, x: 0, y: 0, w: 0, h: 0,
      ...
      { id: 'pr-c3', archetype: 'container', behavior: 'stretch', cell: 2, x: 0, y: 0, w: 0, h: 0,
        props: { background: '#FFFFFF', borderColor: 'rgba(15,23,42,0.08)', borderRadius: 12 } },
...
const LAYOUT_011 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 600, layout: '2col', children: [
    { id: 'sh-left', archetype: 'container', behavior: 'stretch', cell: 0, x: 0, y: 0, w: 0, h: 0,
...
const LAYOUT_013 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 540, layout: '2col', children: [
    ...
    { id: 'fa-card', archetype: 'container', behavior: 'stretch', cell: 1, x: 0, y: 0, w: 0, h: 0,
      props: { background: '#F4F4F5', borderColor: 'transparent', borderRadius: 0 } },
...
const LAYOUT_018 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 460, layout: '3col', children: [
    { id: 'tt-c1', archetype: 'container', behavior: 'stretch', cell: 0, x: 0, y: 0, w: 0, h: 0,
    ...
    { id: 'tt-c2', archetype: 'container', behavior: 'stretch', cell: 1, x: 0, y: 0, w: 0, h: 0,
    ...
    { id: 'tt-c3', archetype: 'container', behavior: 'stretch', cell: 2, x: 0, y: 0, w: 0, h: 0,
      props: { background: '#FFFFFF', borderColor: 'rgba(15,23,42,0.06)', borderRadius: 12 } },
...
const LAYOUT_020 = {
  ...
  sections: [
    ...
    { behavior: 'fixedHeight', height: 200, layout: '4col', children: [
      { id: 'db-1', archetype: 'container', behavior: 'stretch', cell: 0, x: 0, y: 0, w: 0, h: 0,
        props: { background: '#FFFFFF', borderColor: 'rgba(15,23,42,0.06)', borderRadius: 10 } },
      ...
      { id: 'db-2', archetype: 'container', behavior: 'stretch', cell: 1, x: 0, y: 0, w: 0, h: 0,
        props: { background: '#FFFFFF', borderColor: 'rgba(15,23,42,0.06)', borderRadius: 10 } },
      ...
      { id: 'db-3', archetype: 'container', behavior: 'stretch', cell: 2, x: 0, y: 0, w: 0, h: 0,
        props: { background: '#FFFFFF', borderColor: 'rgba(15,23,42,0.06)', borderRadius: 10 } },
      ...
      { id: 'db-4', archetype: 'container', behavior: 'stretch', cell: 3, x: 0, y: 0, w: 0, h: 0,
  ...
  sections: [
    { behavior: 'fixedHeight', height: 280, layout: '2col', children: [
      { id: 'tsb-l', archetype: 'image', behavior: 'stretch', cell: 0, x: 0, y: 0, w: 0, h: 0,
        props: { gradient: 'linear-gradient(135deg, #d4d7f3 0%, #ecedf0 100%)' } },
      { id: 'tsb-r', archetype: 'container', behavior: 'stretch', cell: 1, x: 0, y: 0, w: 0, h: 0,
    ...
    { behavior: 'fixedHeight', height: 280, layout: '2col', children: [
      { id: 'tsb-l2', archetype: 'container', behavior: 'stretch', cell: 0, x: 0, y: 0, w: 0, h: 0,
        props: { background: '#F4F4F5', borderColor: 'transparent', borderRadius: 0 } },
...
const LAYOUT_026 = {
  ...
  sections: [{ behavior: 'auto', height: 1180, layout: 'free', children: [
    { id: 'hdr-bg', archetype: 'container', behavior: 'scaleProportionally', x: 64, y: 40, w: 1152, h: 140,
    ...
    { id: 'list-frame', archetype: 'container', behavior: 'scaleProportionally', anchor: 'hdr-bg', x: 64, y: 24, w: 1152, h: 940,
      props: { background: 'transparent', borderColor: '#D6D3D1', borderRadius: 12 } },
    { id: 'r1', archetype: 'container', behavior: 'scaleProportionally', parent: 'list-frame', x: 32, y: 32, w: 1088, h: 132,
    ...
    { id: 'r2', archetype: 'container', behavior: 'scaleProportionally', anchor: 'r1', parent: 'list-frame', x: 32, y: 8, w: 1088, h: 132,
      props: { background: 'transparent', borderColor: '#E7E5E4', borderRadius: 8 } },
    ...
    { id: 'r2-b', archetype: 'text', behavior: 'scaleProportionally', parent: 'r2', x: 568, y: 28, w: 480, h: 96,
      props: { text: 'Use this space to promote your business, its products or its services. Help people become familiar with the business and its offerings.', fontFamily: 'Inter', fontSize: 13, fontWeight: '400', lineHeight: '1.55', color: '#3F3F46' } },
    { id: 'r3', archetype: 'container', behavior: 'scaleProportionally', anchor: 'r2', parent: 'list-frame', x: 32, y: 8, w: 1088, h: 132,
      props: { background: 'transparent', borderColor: '#E7E5E4', borderRadius: 8 } },
    ...
    { id: 'r3-b', archetype: 'text', behavior: 'scaleProportionally', parent: 'r3', x: 568, y: 28, w: 480, h: 96,
      props: { text: 'Use this space to promote your business, its products or its services. Help people become familiar with the business and its offerings.', fontFamily: 'Inter', fontSize: 13, fontWeight: '400', lineHeight: '1.55', color: '#3F3F46' } },
    { id: 'r4', archetype: 'container', behavior: 'scaleProportionally', anchor: 'r3', parent: 'list-frame', x: 32, y: 8, w: 1088, h: 132,
      props: { background: 'transparent', borderColor: '#E7E5E4', borderRadius: 8 } },
    ...
    { id: 'r4-b', archetype: 'text', behavior: 'scaleProportionally', parent: 'r4', x: 568, y: 28, w: 480, h: 96,
      props: { text: 'Use this space to promote your business, its products or its services. Help people become familiar with the business and its offerings.', fontFamily: 'Inter', fontSize: 13, fontWeight: '400', lineHeight: '1.55', color: '#3F3F46' } },
    { id: 'r5', archetype: 'container', behavior: 'scaleProportionally', anchor: 'r4', parent: 'list-frame', x: 32, y: 8, w: 1088, h: 132,
      props: { background: 'transparent', borderColor: '#E7E5E4', borderRadius: 8 } },
    ...
    { id: 'r5-b', archetype: 'text', behavior: 'scaleProportionally', parent: 'r5', x: 568, y: 28, w: 480, h: 96,
      props: { text: 'Use this space to promote your business, its products or its services. Help people become familiar with the business and its offerings.', fontFamily: 'Inter', fontSize: 13, fontWeight: '400', lineHeight: '1.55', color: '#3F3F46' } },
    { id: 'r6', archetype: 'container', behavior: 'scaleProportionally', anchor: 'r5', parent: 'list-frame', x: 32, y: 8, w: 1088, h: 132,
      props: { background: 'transparent', borderColor: '#E7E5E4', borderRadius: 8 } },
...
const LAYOUT_027 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 720, layout: 'free', children: [
    ...
    { id: 'h-widget', archetype: 'container', behavior: 'scaleProportionally', anchor: 'h-sub', x: 32, y: 56, w: 1216, h: 360,
...
const LAYOUT_029 = {
  ...
  sections: [{ behavior: 'auto', height: 600, layout: 'free', children: [
    ...
    { id: 'a1', archetype: 'container', behavior: 'scaleProportionally', anchor: 'sa-title', x: 256, y: 48, w: 720, h: 64,
    ...
    { id: 'a2', archetype: 'container', behavior: 'scaleProportionally', anchor: 'a1', x: 256, y: 0, w: 720, h: 64,
      props: { background: 'transparent', borderColor: '#E5E5E5', borderRadius: 0 } },
    ...
    { id: 'a2-c', archetype: 'button', behavior: 'fixed', parent: 'a2', x: 612, y: 18, w: 84, h: 28,
      props: { label: 'Read More', variant: 'primary', radius: 4, paddingX: 10, paddingY: 6 } },
    { id: 'a3', archetype: 'container', behavior: 'scaleProportionally', anchor: 'a2', x: 256, y: 0, w: 720, h: 64,
      props: { background: 'transparent', borderColor: '#E5E5E5', borderRadius: 0 } },
    ...
    { id: 'a3-c', archetype: 'button', behavior: 'fixed', parent: 'a3', x: 612, y: 18, w: 84, h: 28,
      props: { label: 'Read More', variant: 'primary', radius: 4, paddingX: 10, paddingY: 6 } },
    { id: 'a4', archetype: 'container', behavior: 'scaleProportionally', anchor: 'a3', x: 256, y: 0, w: 720, h: 64,
      props: { background: 'transparent', borderColor: '#E5E5E5', borderRadius: 0 } },
...
const LAYOUT_030 = {
  ...
  sections: [
    { behavior: 'fixedHeight', height: 100, layout: 'free', children: [
      { id: 'gh', archetype: 'container', behavior: 'scaleProportionally', x: 32, y: 16, w: 1216, h: 76,
        props: { background: '#EAE7DD', borderColor: 'transparent', borderRadius: 8 } },
    ...
    { behavior: 'fixedHeight', height: 280, layout: 'free', children: [
      ...
      { id: 'g-w', archetype: 'container', behavior: 'scaleProportionally', anchor: 'g-tt', x: 672, y: 16, w: 360, h: 140,
    ...
    { behavior: 'fixedHeight', height: 360, layout: 'free', children: [
      ...
      { id: 'p-img', archetype: 'image', behavior: 'scaleProportionally', anchor: 'p-tt', x: 32, y: 24, w: 1216, h: 220,
        props: { objectPosition: 'center' } },
      { id: 'p-card', archetype: 'container', behavior: 'scaleProportionally', parent: 'p-img', x: 600, y: 24, w: 580, h: 180,
    ...
    { behavior: 'fixedHeight', height: 280, layout: 'free', children: [
      ...
      { id: 'rc1', archetype: 'container', behavior: 'scaleProportionally', anchor: 'r-tt', x: 32, y: 24, w: 380, h: 140,
      ...
      { id: 'rc2', archetype: 'container', behavior: 'scaleProportionally', anchor: 'r-tt', x: 444, y: 24, w: 380, h: 140,
        props: { background: '#fff', borderColor: '#E5E5E5', borderRadius: 4 } },
      ...
      { id: 'rc2-c', archetype: 'button', behavior: 'fixed', parent: 'rc2', x: 16, y: 108, w: 348, h: 24,
        props: { label: 'Download', variant: 'primary', radius: 4, paddingX: 10, paddingY: 4 } },
      { id: 'rc3', archetype: 'container', behavior: 'scaleProportionally', anchor: 'r-tt', x: 856, y: 24, w: 380, h: 140,
        props: { background: '#fff', borderColor: '#E5E5E5', borderRadius: 4 } },
...
const LAYOUT_031 = {
  ...
  sections: [{ behavior: 'auto', height: 1000, layout: 'free', children: [
    ...
    { id: 'bs-w', archetype: 'container', behavior: 'scaleProportionally', anchor: 'bs-h1', x: 64, y: 32, w: 720, h: 280,
      props: { background: '#EAE7DD', borderColor: 'transparent', borderRadius: 4 } },
    ...
    { id: 'bs-f', archetype: 'container', behavior: 'scaleProportionally', anchor: 'bs-h2', x: 64, y: 32, w: 720, h: 280,
      props: { background: '#EAE7DD', borderColor: 'transparent', borderRadius: 4 } },
...
const LAYOUT_032 = {
  ...
  sections: [{ behavior: 'auto', height: 820, layout: 'free', children: [
    ...
    { id: 'bc-rule', archetype: 'container', behavior: 'scaleProportionally', anchor: 'bc-title', x: 32, y: 16, w: 1216, h: 1,
      props: { background: '#0f172a', borderColor: 'transparent', borderRadius: 0 } },
...
const LAYOUT_033 = {
  ...
  sections: [{ behavior: 'auto', height: 1100, layout: 'free', children: [
    ...
    { id: 'ba-r1', archetype: 'container', behavior: 'scaleProportionally', anchor: 'ba-pa', x: 240, y: 32, w: 800, h: 60,
      props: { background: 'transparent', borderColor: '#E5E5E5', borderRadius: 0 } },
    ...
    { id: 'ba-r2', archetype: 'container', behavior: 'scaleProportionally', anchor: 'ba-r1', x: 240, y: 0, w: 800, h: 60,
      props: { background: 'transparent', borderColor: '#E5E5E5', borderRadius: 0 } },
    ...
    { id: 'ba-r2d', archetype: 'text', behavior: 'scaleProportionally', parent: 'ba-r2', x: 320, y: 14, w: 460, h: 36,
      props: { text: 'This is the space to outline your areas of expertise.', fontFamily: 'Inter', fontSize: 11, color: '#52525B' } },
    { id: 'ba-r3', archetype: 'container', behavior: 'scaleProportionally', anchor: 'ba-r2', x: 240, y: 0, w: 800, h: 60,
      props: { background: 'transparent', borderColor: '#E5E5E5', borderRadius: 0 } },
    ...
    { id: 'ba-r3d', archetype: 'text', behavior: 'scaleProportionally', parent: 'ba-r3', x: 320, y: 14, w: 460, h: 36,
      props: { text: 'This is the space to outline your areas of expertise.', fontFamily: 'Inter', fontSize: 11, color: '#52525B' } },
    { id: 'ba-w', archetype: 'container', behavior: 'scaleProportionally', anchor: 'ba-r3', x: 240, y: 32, w: 800, h: 200,
      props: { background: '#EAE7DD', borderColor: 'transparent', borderRadius: 4 } },
...
const LAYOUT_034 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 580, layout: 'free', children: [
    ...
    { id: 'da-w', archetype: 'container', behavior: 'scaleProportionally', anchor: 'da-t', x: 16, y: 16, w: 1248, h: 380,
...
const LAYOUT_035 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 480, layout: 'free', children: [
    { id: 'd35-bg', archetype: 'container', behavior: 'scaleProportionally', x: 0, y: 0, w: 1280, h: 480,
      props: { background: '#000', borderColor: 'transparent', borderRadius: 0 } },
    { id: 'd35-c1', archetype: 'container', behavior: 'scaleProportionally', x: 32, y: 240, w: 384, h: 200,
    ...
    { id: 'd35-c2', archetype: 'container', behavior: 'scaleProportionally', x: 448, y: 240, w: 384, h: 200,
      props: { background: '#fff', borderColor: 'transparent', borderRadius: 0 } },
    ...
    { id: 'd35-c2b', archetype: 'text', behavior: 'scaleProportionally', parent: 'd35-c2', x: 32, y: 68, w: 320, h: 100,
      props: { text: 'Add paragraph text. Click "Edit Text" to update the font, size and more. To change and reuse text themes, go to Site Styles.', fontFamily: 'Inter', fontSize: 12, lineHeight: '1.55', color: '#52525B', textAlign: 'center' } },
    { id: 'd35-c3', archetype: 'container', behavior: 'scaleProportionally', x: 864, y: 240, w: 384, h: 200,
      props: { background: '#fff', borderColor: 'transparent', borderRadius: 0 } },
...
const LAYOUT_036 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 540, layout: 'free', children: [
    { id: 'd36-bg', archetype: 'container', behavior: 'scaleProportionally', x: 0, y: 0, w: 1280, h: 540,
      props: { background: '#000', borderColor: 'transparent', borderRadius: 0 } },
    { id: 'd36-c1', archetype: 'container', behavior: 'scaleProportionally', x: 56, y: 184, w: 252, h: 296,
    ...
    { id: 'd36-c2', archetype: 'container', behavior: 'scaleProportionally', x: 340, y: 184, w: 252, h: 296,
      props: { background: '#fff', borderColor: 'transparent', borderRadius: 8 } },
    ...
    { id: 'd36-c2c', archetype: 'button', behavior: 'fixed', parent: 'd36-c2', x: 76, y: 224, w: 100, h: 36,
      props: { label: 'Read More', variant: 'ghost', radius: 999, paddingX: 16, paddingY: 8 } },
    { id: 'd36-c3', archetype: 'container', behavior: 'scaleProportionally', x: 624, y: 184, w: 252, h: 296,
      props: { background: '#fff', borderColor: 'transparent', borderRadius: 8 } },
    ...
    { id: 'd36-c3c', archetype: 'button', behavior: 'fixed', parent: 'd36-c3', x: 76, y: 224, w: 100, h: 36,
      props: { label: 'Read More', variant: 'ghost', radius: 999, paddingX: 16, paddingY: 8 } },
    { id: 'd36-c4', archetype: 'container', behavior: 'scaleProportionally', x: 908, y: 184, w: 252, h: 296,
      props: { background: '#fff', borderColor: 'transparent', borderRadius: 8 } },
...
const LAYOUT_037 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 460, layout: 'free', children: [
    { id: 'd37-bg', archetype: 'container', behavior: 'scaleProportionally', x: 0, y: 0, w: 1280, h: 460,
      props: { background: '#000', borderColor: 'transparent', borderRadius: 0 } },
    { id: 'd37-c1', archetype: 'container', behavior: 'scaleProportionally', x: 56, y: 200, w: 252, h: 200,
      props: { background: '#EAE7DD', borderColor: 'transparent', borderRadius: 8 } },
    ...
    { id: 'd37-c2', archetype: 'container', behavior: 'scaleProportionally', x: 340, y: 200, w: 252, h: 200,
      props: { background: '#EAE7DD', borderColor: 'transparent', borderRadius: 8 } },
    ...
    { id: 'd37-c2c', archetype: 'button', behavior: 'fixed', parent: 'd37-c2', x: 76, y: 148, w: 100, h: 32,
      props: { label: 'Read More', variant: 'ghost', radius: 999, paddingX: 14, paddingY: 6 } },
    { id: 'd37-c3', archetype: 'container', behavior: 'scaleProportionally', x: 624, y: 200, w: 252, h: 200,
      props: { background: '#EAE7DD', borderColor: 'transparent', borderRadius: 8 } },
...
const LAYOUT_038 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 540, layout: 'free', children: [
    { id: 'd38-bg', archetype: 'container', behavior: 'scaleProportionally', x: 0, y: 0, w: 1280, h: 540,
      props: { background: '#000', borderColor: 'transparent', borderRadius: 0 } },
    { id: 'd38-c1', archetype: 'container', behavior: 'scaleProportionally', x: 360, y: 16, w: 280, h: 240,
      props: { background: '#fff', borderColor: 'transparent', borderRadius: 8 } },
    ...
    { id: 'd38-c2', archetype: 'container', behavior: 'scaleProportionally', x: 672, y: 16, w: 280, h: 240,
      props: { background: '#fff', borderColor: 'transparent', borderRadius: 8 } },
    ...
    { id: 'd38-c2c', archetype: 'text', behavior: 'fixed', parent: 'd38-c2', x: 16, y: 200, w: 100, h: 18,
      props: { text: 'Read More', fontFamily: 'Inter', fontSize: 11, fontWeight: '500', color: '#0f172a' } },
    { id: 'd38-c3', archetype: 'container', behavior: 'scaleProportionally', x: 360, y: 280, w: 280, h: 240,
      props: { background: '#fff', borderColor: 'transparent', borderRadius: 8 } },
    ...
    { id: 'd38-c3c', archetype: 'text', behavior: 'fixed', parent: 'd38-c3', x: 16, y: 200, w: 100, h: 18,
      props: { text: 'Read More', fontFamily: 'Inter', fontSize: 11, fontWeight: '500', color: '#0f172a' } },
    { id: 'd38-c4', archetype: 'container', behavior: 'scaleProportionally', x: 672, y: 280, w: 280, h: 240,
      props: { background: '#fff', borderColor: 'transparent', borderRadius: 8 } },
...
const LAYOUT_039 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 540, layout: 'free', children: [
    { id: 'd39-bg', archetype: 'container', behavior: 'scaleProportionally', x: 0, y: 0, w: 1280, h: 540,
      props: { background: '#000', borderColor: 'transparent', borderRadius: 0 } },
...
const LAYOUT_040 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 540, layout: 'free', children: [
    { id: 'd40-bg', archetype: 'container', behavior: 'scaleProportionally', x: 0, y: 0, w: 1280, h: 540,
      props: { background: '#000', borderColor: 'transparent', borderRadius: 0 } },
...
const LAYOUT_041 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 600, layout: 'free', children: [
    { id: 'd41-bg', archetype: 'container', behavior: 'scaleProportionally', x: 0, y: 0, w: 1280, h: 600,
      props: { background: '#000', borderColor: 'transparent', borderRadius: 0 } },
    { id: 'd41-c1', archetype: 'container', behavior: 'scaleProportionally', x: 540, y: 32, w: 220, h: 268,
    ...
    { id: 'd41-c2', archetype: 'container', behavior: 'scaleProportionally', x: 780, y: 32, w: 220, h: 268,
      props: { background: 'transparent', borderColor: 'transparent', borderRadius: 0 } },
    ...
    { id: 'd41-c2t', archetype: 'text', behavior: 'fixed', parent: 'd41-c2', x: 12, y: 232, w: 196, h: 24,
      props: { text: 'Item Title', fontFamily: 'Inter', fontSize: 13, fontWeight: '500', color: '#0f172a' } },
    { id: 'd41-c3', archetype: 'container', behavior: 'scaleProportionally', x: 540, y: 320, w: 220, h: 268,
      props: { background: 'transparent', borderColor: 'transparent', borderRadius: 0 } },
    ...
    { id: 'd41-c3t', archetype: 'text', behavior: 'fixed', parent: 'd41-c3', x: 12, y: 232, w: 196, h: 24,
      props: { text: 'Item Title', fontFamily: 'Inter', fontSize: 13, fontWeight: '500', color: '#0f172a' } },
    { id: 'd41-c4', archetype: 'container', behavior: 'scaleProportionally', x: 780, y: 320, w: 220, h: 268,
      props: { background: 'transparent', borderColor: 'transparent', borderRadius: 0 } },
...
const LAYOUT_042 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 480, layout: 'free', children: [
    ...
    { id: 'd42-c1', archetype: 'container', behavior: 'scaleProportionally', x: 64, y: 144, w: 360, h: 200,
    ...
    { id: 'd42-c1b', archetype: 'text', behavior: 'scaleProportionally', parent: 'd42-c1', x: 16, y: 64, w: 328, h: 100,
      props: { text: 'Add paragraph text. Click "Edit Text" to update the font, size and more.', fontFamily: 'Inter', fontSize: 12, lineHeight: '1.55', color: '#52525B', textAlign: 'center' } },
    { id: 'd42-c2', archetype: 'container', behavior: 'scaleProportionally', x: 460, y: 144, w: 360, h: 200,
      props: { background: 'rgba(255,255,255,0.55)', borderColor: 'transparent', borderRadius: 8 } },
    ...
    { id: 'd42-c2b', archetype: 'text', behavior: 'scaleProportionally', parent: 'd42-c2', x: 16, y: 64, w: 328, h: 100,
      props: { text: 'Add paragraph text. Click "Edit Text" to update the font, size and more.', fontFamily: 'Inter', fontSize: 12, lineHeight: '1.55', color: '#52525B', textAlign: 'center' } },
    { id: 'd42-c3', archetype: 'container', behavior: 'scaleProportionally', x: 856, y: 144, w: 360, h: 200,
      props: { background: 'rgba(255,255,255,0.55)', borderColor: 'transparent', borderRadius: 8 } },
...
const LAYOUT_043 = {
  ...
  sections: [{ behavior: 'auto', height: 1100, layout: 'free', children: [
    { id: 'd43-hd', archetype: 'container', behavior: 'scaleProportionally', x: 32, y: 32, w: 1216, h: 100,
    ...
    { id: 'd43-r1c1', archetype: 'container', behavior: 'scaleProportionally', anchor: 'd43-hd', x: 32, y: 16, w: 405, h: 252,
      props: { background: 'transparent', borderColor: '#E5E5E5', borderRadius: 0 } },
    ...
    { id: 'd43-r1c2', archetype: 'container', behavior: 'scaleProportionally', anchor: 'd43-hd', x: 437, y: 16, w: 405, h: 252,
      props: { background: 'transparent', borderColor: '#E5E5E5', borderRadius: 0 } },
    ...
    { id: 'd43-r1c2b', archetype: 'text', behavior: 'scaleProportionally', parent: 'd43-r1c2', x: 24, y: 116, w: 360, h: 90,
      props: { text: 'Use this space to promote your business, its products or its services.', fontFamily: 'Inter', fontSize: 12, lineHeight: '1.55', color: '#52525B' } },
    { id: 'd43-r1c3', archetype: 'container', behavior: 'scaleProportionally', anchor: 'd43-hd', x: 842, y: 16, w: 406, h: 252,
      props: { background: 'transparent', borderColor: '#E5E5E5', borderRadius: 0 } },
    ...
    { id: 'd43-r1c3b', archetype: 'text', behavior: 'scaleProportionally', parent: 'd43-r1c3', x: 24, y: 116, w: 360, h: 90,
      props: { text: 'Use this space to promote your business, its products or its services.', fontFamily: 'Inter', fontSize: 12, lineHeight: '1.55', color: '#52525B' } },
    { id: 'd43-r2c1', archetype: 'container', behavior: 'scaleProportionally', anchor: 'd43-r1c1', x: 32, y: 0, w: 405, h: 252,
      props: { background: 'transparent', borderColor: '#E5E5E5', borderRadius: 0 } },
    ...
    { id: 'd43-r2c1b', archetype: 'text', behavior: 'scaleProportionally', parent: 'd43-r2c1', x: 24, y: 116, w: 360, h: 90,
      props: { text: 'Use this space to promote your business, its products or its services.', fontFamily: 'Inter', fontSize: 12, lineHeight: '1.55', color: '#52525B' } },
    { id: 'd43-r2c2', archetype: 'container', behavior: 'scaleProportionally', anchor: 'd43-r1c1', x: 437, y: 0, w: 405, h: 252,
      props: { background: 'transparent', borderColor: '#E5E5E5', borderRadius: 0 } },
    ...
    { id: 'd43-r2c2b', archetype: 'text', behavior: 'scaleProportionally', parent: 'd43-r2c2', x: 24, y: 116, w: 360, h: 90,
      props: { text: 'Use this space to promote your business, its products or its services.', fontFamily: 'Inter', fontSize: 12, lineHeight: '1.55', color: '#52525B' } },
    { id: 'd43-r2c3', archetype: 'container', behavior: 'scaleProportionally', anchor: 'd43-r1c1', x: 842, y: 0, w: 406, h: 252,
      props: { background: 'transparent', borderColor: '#E5E5E5', borderRadius: 0 } },
...
const LAYOUT_044 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 540, layout: 'free', children: [
    { id: 'd44-bg', archetype: 'container', behavior: 'scaleProportionally', x: 0, y: 0, w: 1280, h: 540,
      props: { background: '#000', borderColor: 'transparent', borderRadius: 0 } },
    { id: 'd44-c1', archetype: 'container', behavior: 'scaleProportionally', x: 656, y: 32, w: 280, h: 220,
      props: { background: '#fff', borderColor: 'transparent', borderRadius: 8 } },
    ...
    { id: 'd44-c1c', archetype: 'text', behavior: 'fixed', parent: 'd44-c1', x: 16, y: 184, w: 100, h: 16,
      props: { text: 'Read More', fontFamily: 'Inter', fontSize: 11, fontWeight: '500', color: '#0f172a' } },
    { id: 'd44-c2', archetype: 'container', behavior: 'scaleProportionally', x: 968, y: 32, w: 280, h: 220,
      props: { background: '#fff', borderColor: 'transparent', borderRadius: 8 } },
    ...
    { id: 'd44-c2c', archetype: 'text', behavior: 'fixed', parent: 'd44-c2', x: 16, y: 184, w: 100, h: 16,
      props: { text: 'Read More', fontFamily: 'Inter', fontSize: 11, fontWeight: '500', color: '#0f172a' } },
    { id: 'd44-c3', archetype: 'container', behavior: 'scaleProportionally', x: 656, y: 280, w: 280, h: 220,
      props: { background: '#fff', borderColor: 'transparent', borderRadius: 8 } },
    ...
    { id: 'd44-c3c', archetype: 'text', behavior: 'fixed', parent: 'd44-c3', x: 16, y: 184, w: 100, h: 16,
      props: { text: 'Read More', fontFamily: 'Inter', fontSize: 11, fontWeight: '500', color: '#0f172a' } },
    { id: 'd44-c4', archetype: 'container', behavior: 'scaleProportionally', x: 968, y: 280, w: 280, h: 220,
      props: { background: '#fff', borderColor: 'transparent', borderRadius: 8 } },
...
const LAYOUT_045 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 660, layout: 'free', children: [
    ...
    { id: 'd45-mid', archetype: 'container', behavior: 'scaleProportionally', x: 432, y: 32, w: 120, h: 380,
    ...
    { id: 'd45-r', archetype: 'container', behavior: 'scaleProportionally', x: 572, y: 32, w: 676, h: 200,
...
const LAYOUT_046 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 580, layout: 'free', children: [
    { id: 'd46-l', archetype: 'container', behavior: 'scaleProportionally', x: 32, y: 32, w: 580, h: 220,
      props: { background: '#F4F4F5', borderColor: 'transparent', borderRadius: 8 } },
    ...
    { id: 'd46-c1', archetype: 'container', behavior: 'scaleProportionally', x: 32, y: 284, w: 392, h: 240,
      props: { background: '#F4F4F5', borderColor: 'transparent', borderRadius: 8 } },
    ...
    { id: 'd46-c2', archetype: 'container', behavior: 'scaleProportionally', x: 444, y: 284, w: 392, h: 240,
      props: { background: '#F4F4F5', borderColor: 'transparent', borderRadius: 8 } },
    ...
    { id: 'd46-c2b', archetype: 'text', behavior: 'scaleProportionally', parent: 'd46-c2', x: 16, y: 172, w: 360, h: 60,
      props: { text: 'Describe the item here. Include important features, pricing and other relevant info.', fontFamily: 'Inter', fontSize: 11, lineHeight: '1.55', color: '#52525B', textAlign: 'center' } },
    { id: 'd46-c3', archetype: 'container', behavior: 'scaleProportionally', x: 856, y: 284, w: 392, h: 240,
      props: { background: '#F4F4F5', borderColor: 'transparent', borderRadius: 8 } },
...
const LAYOUT_047 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 580, layout: 'free', children: [
    { id: 'd47-l', archetype: 'container', behavior: 'scaleProportionally', x: 32, y: 32, w: 580, h: 280,
      props: { background: '#F4F4F5', borderColor: 'transparent', borderRadius: 8 } },
    ...
    { id: 'd47-bl', archetype: 'container', behavior: 'scaleProportionally', x: 32, y: 332, w: 580, h: 220,
      props: { background: '#F4F4F5', borderColor: 'transparent', borderRadius: 8 } },
...
const LAYOUT_048 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 460, layout: 'free', children: [
    { id: 'd48-bg', archetype: 'container', behavior: 'scaleProportionally', x: 0, y: 0, w: 1280, h: 460,
    ...
    { id: 'd48-m', archetype: 'container', behavior: 'scaleProportionally', x: 332, y: 96, w: 480, h: 280,
      props: { background: '#F4F4F5', borderColor: 'transparent', borderRadius: 8 } },
...
const LAYOUT_049 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 540, layout: 'free', children: [
    ...
    { id: 'd49-tt', archetype: 'text', behavior: 'scaleProportionally', anchor: 'd49-eye', x: 800, y: 12, w: 400, h: 36,
      props: { text: 'Quick answers', fontFamily: 'Inter', fontSize: 28, fontWeight: '500', color: '#0f172a' } },
    { id: 'd49-w', archetype: 'container', behavior: 'scaleProportionally', anchor: 'd49-tt', x: 800, y: 24, w: 416, h: 200,
      props: { background: 'transparent', borderColor: '#E5E5E5', borderRadius: 4 } },
...
const LAYOUT_050 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 560, layout: 'free', children: [
    { id: 'd50-l', archetype: 'container', behavior: 'scaleProportionally', x: 32, y: 32, w: 380, h: 480,
      props: { background: '#F4F4F5', borderColor: 'transparent', borderRadius: 8 } },
    ...
    { id: 'd50-r', archetype: 'container', behavior: 'scaleProportionally', x: 856, y: 32, w: 392, h: 480,
      props: { background: '#F4F4F5', borderColor: 'transparent', borderRadius: 8 } },
...
const LAYOUT_051 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 480, layout: 'free', children: [
    ...
    { id: 'd51-r', archetype: 'container', behavior: 'scaleProportionally', x: 480, y: 0, w: 800, h: 480,
      props: { background: '#fff', borderColor: 'transparent', borderRadius: 0 } },
...
const LAYOUT_052 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 540, layout: 'free', children: [
    { id: 'd52-l', archetype: 'container', behavior: 'scaleProportionally', x: 32, y: 32, w: 580, h: 240,
      props: { background: '#F4F4F5', borderColor: 'transparent', borderRadius: 8 } },
    ...
    { id: 'd52-c1', archetype: 'container', behavior: 'scaleProportionally', x: 32, y: 304, w: 392, h: 200,
      props: { background: '#F4F4F5', borderColor: 'transparent', borderRadius: 8 } },
    ...
    { id: 'd52-c1b', archetype: 'text', behavior: 'scaleProportionally', parent: 'd52-c1', x: 16, y: 124, w: 360, h: 60,
      props: { text: 'Describe the item here. Include important features, pricing and other relevant info.', fontFamily: 'Inter', fontSize: 11, lineHeight: '1.55', color: '#52525B', textAlign: 'center' } },
    { id: 'd52-c2', archetype: 'container', behavior: 'scaleProportionally', x: 444, y: 304, w: 392, h: 200,
      props: { background: '#F4F4F5', borderColor: 'transparent', borderRadius: 8 } },
    ...
    { id: 'd52-c2b', archetype: 'text', behavior: 'scaleProportionally', parent: 'd52-c2', x: 16, y: 124, w: 360, h: 60,
      props: { text: 'Describe the item here. Include important features, pricing and other relevant info.', fontFamily: 'Inter', fontSize: 11, lineHeight: '1.55', color: '#52525B', textAlign: 'center' } },
    { id: 'd52-c3', archetype: 'container', behavior: 'scaleProportionally', x: 856, y: 304, w: 392, h: 200,
      props: { background: '#F4F4F5', borderColor: 'transparent', borderRadius: 8 } },
...
const LAYOUT_053 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 460, layout: 'free', children: [
    { id: 'd53-bg', archetype: 'container', behavior: 'scaleProportionally', x: 640, y: 0, w: 640, h: 460,
      props: { background: '#000', borderColor: 'transparent', borderRadius: 0 } },
    { id: 'd53-l', archetype: 'container', behavior: 'scaleProportionally', x: 32, y: 32, w: 580, h: 396,
    ...
    { id: 'd53-r1', archetype: 'container', behavior: 'scaleProportionally', x: 660, y: 80, w: 580, h: 140,
      props: { background: '#fff', borderColor: 'transparent', borderRadius: 8 } },
    ...
    { id: 'd53-r2', archetype: 'container', behavior: 'scaleProportionally', x: 660, y: 240, w: 580, h: 140,
      props: { background: '#fff', borderColor: 'transparent', borderRadius: 8 } },
...
const LAYOUT_054 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 540, layout: 'free', children: [
    { id: 'd54-bg', archetype: 'container', behavior: 'scaleProportionally', x: 0, y: 0, w: 1280, h: 540,
    ...
    { id: 'd54-l-c', archetype: 'button', behavior: 'fixed', anchor: 'd54-l-b', x: 64, y: 24, w: 100, h: 36,
      props: { label: 'Read More', variant: 'ghost', radius: 999, paddingX: 16, paddingY: 8 } },
    { id: 'd54-c1', archetype: 'container', behavior: 'scaleProportionally', x: 600, y: 64, w: 320, h: 200,
    ...
    { id: 'd54-c2', archetype: 'container', behavior: 'scaleProportionally', x: 936, y: 64, w: 320, h: 200,
      props: { background: 'rgba(255,255,255,0.10)', borderColor: 'transparent', borderRadius: 8 } },
    ...
    { id: 'd54-c3', archetype: 'container', behavior: 'scaleProportionally', x: 600, y: 280, w: 320, h: 200,
      props: { background: 'rgba(255,255,255,0.10)', borderColor: 'transparent', borderRadius: 8 } },
    ...
    { id: 'd54-c4', archetype: 'container', behavior: 'scaleProportionally', x: 936, y: 280, w: 320, h: 200,
      props: { background: 'rgba(255,255,255,0.10)', borderColor: 'transparent', borderRadius: 8 } },
...
const LAYOUT_055 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 480, layout: 'free', children: [
    { id: 'd55-bg', archetype: 'container', behavior: 'scaleProportionally', x: 0, y: 0, w: 1280, h: 480,
      props: { background: '#000', borderColor: 'transparent', borderRadius: 0 } },
...
const LAYOUT_056 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 460, layout: 'free', children: [
    { id: 'd56-bg', archetype: 'container', behavior: 'scaleProportionally', x: 0, y: 0, w: 1280, h: 460,
      props: { background: '#000', borderColor: 'transparent', borderRadius: 0 } },
...
const LAYOUT_057 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 460, layout: 'free', children: [
    { id: 'd57-bg', archetype: 'container', behavior: 'scaleProportionally', x: 0, y: 0, w: 1280, h: 460,
      props: { background: '#000', borderColor: 'transparent', borderRadius: 0 } },
    { id: 'd57-card', archetype: 'container', behavior: 'scaleProportionally', x: 96, y: 80, w: 1088, h: 300,
...
const LAYOUT_058 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 440, layout: 'free', children: [
    { id: 'd58-bg', archetype: 'container', behavior: 'scaleProportionally', x: 0, y: 0, w: 1280, h: 440,
      props: { background: '#000', borderColor: 'transparent', borderRadius: 0 } },
...
const LAYOUT_059 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 440, layout: 'free', children: [
    { id: 'd59-bg', archetype: 'container', behavior: 'scaleProportionally', x: 0, y: 0, w: 1280, h: 440,
      props: { background: '#000', borderColor: 'transparent', borderRadius: 0 } },
...
const LAYOUT_060 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 440, layout: 'free', children: [
    { id: 'd60-bg', archetype: 'container', behavior: 'scaleProportionally', x: 0, y: 0, w: 1280, h: 440,
      props: { background: '#000', borderColor: 'transparent', borderRadius: 0 } },
...
const LAYOUT_061 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 440, layout: 'free', children: [
    { id: 'd61-bg', archetype: 'container', behavior: 'scaleProportionally', x: 0, y: 0, w: 1280, h: 440,
      props: { background: '#000', borderColor: 'transparent', borderRadius: 0 } },
...
const LAYOUT_062 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 440, layout: 'free', children: [
    { id: 'd62-bg', archetype: 'container', behavior: 'scaleProportionally', x: 0, y: 0, w: 1280, h: 440,
      props: { background: '#0a0a0a', borderColor: 'transparent', borderRadius: 0 } },
    { id: 'd62-card', archetype: 'container', behavior: 'scaleProportionally', x: 760, y: 96, w: 460, h: 220,
      props: { background: '#fff', borderColor: 'transparent', borderRadius: 0 } },
...
const LAYOUT_063 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 440, layout: 'free', children: [
    { id: 'd63-bg', archetype: 'container', behavior: 'scaleProportionally', x: 0, y: 0, w: 1280, h: 440,
      props: { background: '#000', borderColor: 'transparent', borderRadius: 0 } },
...
const LAYOUT_064 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 280, layout: 'free', children: [
    ...
    { id: 'd64-w', archetype: 'container', behavior: 'scaleProportionally', anchor: 'd64-tt', x: 360, y: 24, w: 460, h: 120,
      props: { background: 'transparent', borderColor: '#E5E5E5', borderRadius: 4 } },
...
const LAYOUT_065 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 540, layout: 'free', children: [
    { id: 'd65-bg', archetype: 'container', behavior: 'scaleProportionally', x: 0, y: 0, w: 1280, h: 540,
      props: { background: '#000', borderColor: 'transparent', borderRadius: 0 } },
...
const LAYOUT_067 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 440, layout: 'free', children: [
    { id: 'd67-bg', archetype: 'container', behavior: 'scaleProportionally', x: 640, y: 0, w: 640, h: 440,
      props: { background: '#000', borderColor: 'transparent', borderRadius: 0 } },
...
const LAYOUT_068 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 440, layout: 'free', children: [
    { id: 'd68-bg', archetype: 'container', behavior: 'scaleProportionally', x: 640, y: 0, w: 640, h: 440,
      props: { background: '#000', borderColor: 'transparent', borderRadius: 0 } },
...
const LAYOUT_069 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 440, layout: 'free', children: [
    { id: 'd69-bg', archetype: 'container', behavior: 'scaleProportionally', x: 640, y: 0, w: 640, h: 440,
      props: { background: '#000', borderColor: 'transparent', borderRadius: 0 } },
...
const LAYOUT_070 = {
  ...
  sections: [
    ...
    { behavior: 'fixedHeight', height: 320, layout: 'free', children: [
      ...
      { id: 'sp-c1', archetype: 'container', behavior: 'scaleProportionally', anchor: 'sp-t2', x: 32, y: 24, w: 392, h: 200,
        props: { background: 'transparent', borderColor: '#E5E5E5', borderRadius: 0 } },
      ...
      { id: 'sp-c2', archetype: 'container', behavior: 'scaleProportionally', anchor: 'sp-t2', x: 444, y: 24, w: 392, h: 200,
        props: { background: 'transparent', borderColor: '#E5E5E5', borderRadius: 0 } },
      ...
      { id: 'sp-c2c', archetype: 'button', behavior: 'fixed', parent: 'sp-c2', x: 16, y: 168, w: 84, h: 24,
        props: { label: 'Book Now', variant: 'primary', radius: 4, paddingX: 10, paddingY: 4 } },
      { id: 'sp-c3', archetype: 'container', behavior: 'scaleProportionally', anchor: 'sp-t2', x: 856, y: 24, w: 392, h: 200,
        props: { background: 'transparent', borderColor: '#E5E5E5', borderRadius: 0 } },
    ...
    { behavior: 'fixedHeight', height: 280, layout: 'free', children: [
      ...
      { id: 'sp-fr1', archetype: 'container', behavior: 'scaleProportionally', anchor: 'sp-ft', x: 32, y: 24, w: 1216, h: 44,
        props: { background: 'transparent', borderColor: '#E5E5E5', borderRadius: 0 } },
      ...
      { id: 'sp-fr2', archetype: 'container', behavior: 'scaleProportionally', anchor: 'sp-fr1', x: 32, y: 0, w: 1216, h: 44,
        props: { background: 'transparent', borderColor: '#E5E5E5', borderRadius: 0 } },
...
const LAYOUT_071 = {
  ...
  sections: [
    ...
    { behavior: 'fixedHeight', height: 360, layout: 'free', children: [
      ...
      { id: 'sc-r1', archetype: 'container', behavior: 'scaleProportionally', anchor: 'sc-tt', x: 32, y: 24, w: 600, h: 60,
        props: { background: 'transparent', borderColor: '#E5E5E5', borderRadius: 0 } },
      ...
      { id: 'sc-r2', archetype: 'container', behavior: 'scaleProportionally', anchor: 'sc-r1', x: 32, y: 8, w: 600, h: 60,
        props: { background: 'transparent', borderColor: '#E5E5E5', borderRadius: 0 } },
      ...
      { id: 'sc-r3', archetype: 'container', behavior: 'scaleProportionally', anchor: 'sc-r2', x: 32, y: 8, w: 600, h: 60,
        props: { background: 'transparent', borderColor: '#E5E5E5', borderRadius: 0 } },
    ...
    { behavior: 'fixedHeight', height: 220, layout: 'free', children: [
      { id: 'sc-w', archetype: 'container', behavior: 'scaleProportionally', x: 32, y: 32, w: 1216, h: 156,
        props: { background: '#EAE7DD', borderColor: 'transparent', borderRadius: 4 } },
...
const LAYOUT_072 = {
  ...
  sections: [
    ...
    { behavior: 'fixedHeight', height: 360, layout: 'free', children: [
      ...
      { id: 'ss-r1', archetype: 'container', behavior: 'scaleProportionally', anchor: 'ss-tt2', x: 32, y: 24, w: 1216, h: 64,
        props: { background: 'transparent', borderColor: '#E5E5E5', borderRadius: 0 } },
      ...
      { id: 'ss-r2', archetype: 'container', behavior: 'scaleProportionally', anchor: 'ss-r1', x: 32, y: 8, w: 1216, h: 64,
        props: { background: 'transparent', borderColor: '#E5E5E5', borderRadius: 0 } },
...
const LAYOUT_073 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 360, layout: 'free', children: [
    { id: 'd73-bg', archetype: 'container', behavior: 'scaleProportionally', x: 0, y: 0, w: 1280, h: 280,
      props: { background: '#000', borderColor: 'transparent', borderRadius: 0 } },
    ...
    { id: 'd73-pr-l', archetype: 'text', behavior: 'fixed', parent: 'd73-pr', x: 0, y: 8, w: 36, h: 20,
      props: { text: '\u2192', fontFamily: 'Inter', fontSize: 14, color: '#0f172a', textAlign: 'center' } },
    { id: 'd73-strip', archetype: 'container', behavior: 'scaleProportionally', x: 0, y: 280, w: 1280, h: 80,
...
const LAYOUT_074 = {
  ...
  sections: [{ behavior: 'fixedHeight', height: 360, layout: 'free', children: [
    { id: 'd74-bg', archetype: 'container', behavior: 'scaleProportionally', x: 0, y: 0, w: 640, h: 360,
      props: { background: '#000', borderColor: 'transparent', borderRadius: 0 } },
...
const LAYOUT_075 = {
  ...
  sections: [
    ...
    { behavior: 'fixedHeight', height: 380, layout: 'free', children: [
      ...
      { id: 'wd-w', archetype: 'container', behavior: 'scaleProportionally', anchor: 'wd-eye', x: 96, y: 24, w: 1088, h: 280,
        props: { background: '#EAE7DD', borderColor: 'transparent', borderRadius: 0 } },
  ...
  sections: [
    ...
    },
    {
      ...
      children: [
        ...
        { id: 'manifesto-sub', archetype: 'text', behavior: 'cellFit', cell: 1, anchor: 'manifesto',
          x: 24, y: 36, w: 0, h: 0,
    ...
    },
    {
      ...
      layout: '3col',
      children: [
        { id: 'h-col0-title', archetype: 'text', behavior: 'cellFit', cell: 0,
          x: 24, y: 80, w: 0, h: 0,
        ...
        { id: 'h-col0-body', archetype: 'text', behavior: 'cellFit', cell: 0, anchor: 'h-col0-title',
          x: 24, y: 24, w: 0, h: 0,
        ...
        { id: 'house-1', archetype: 'container', behavior: 'cellFit', cell: 1,
        ...
        { id: 'house-1-img', archetype: 'image', behavior: 'stretch', parent: 'house-1',
          x: 0, y: 0, w: 384, h: 320,
          props: { objectPosition: 'center' } },
        { id: 'h1-title', archetype: 'text', behavior: 'cellFit', parent: 'house-1',
        ...
        { id: 'h1-meta', archetype: 'text', behavior: 'cellFit', parent: 'house-1', anchor: 'h1-title',
          x: 24, y: 8, w: 336, h: 36,
        ...
        { id: 'house-2', archetype: 'container', behavior: 'cellFit', cell: 2,
          x: 0, y: 80, w: 384, h: 440,
          props: { background: '#FAFAF9', borderColor: '#E7E5E4', borderRadius: 4 } },
        { id: 'house-2-img', archetype: 'image', behavior: 'stretch', parent: 'house-2',
          x: 0, y: 0, w: 384, h: 320,
          props: { objectPosition: 'center' } },
        { id: 'h2-title', archetype: 'text', behavior: 'cellFit', parent: 'house-2',
          x: 24, y: 344, w: 336, h: 24,
          props: { text: 'House no. 11 \u2014 Ericeira', fontFamily: 'IBM Plex Serif', fontSize: 17, fontWeight: '400', color: '#18181B', letterSpacing: '-0.005em' } },
        { id: 'h2-meta', archetype: 'text', behavior: 'cellFit', parent: 'house-2', anchor: 'h2-title',
          x: 24, y: 8, w: 336, h: 36,
...
const LAYOUT_E02 = {
  ...
  sections: [
    ...
    },
    {
      ...
      layout: '3col',
      children: [
        { id: 'feat-eyebrow', archetype: 'text', behavior: 'cellFit', cell: 0,
          x: 96, y: 96, w: 0, h: 0,
          props: { text: 'WHAT YOU GET', fontFamily: 'Inter', fontSize: 11, fontWeight: '500', letterSpacing: '0.14em', color: '#78716C' } },
        { id: 'feat-title', archetype: 'text', behavior: 'cellFit', cell: 0, anchor: 'feat-eyebrow',
          x: 96, y: 20, w: 0, h: 0,
        ...
        { id: 'm1-body', archetype: 'text', behavior: 'cellFit', parent: 'mod-1', anchor: 'm1-title',
        ...
        { id: 'mod-2', archetype: 'container', behavior: 'cellFit', cell: 2,
          x: 0, y: 96, w: 384, h: 360,
          props: { background: '#FAFAF9', borderColor: '#E7E5E4', borderRadius: 12 } },
        { id: 'm2-num', archetype: 'text', behavior: 'cellFit', parent: 'mod-2',
          x: 32, y: 32, w: 80, h: 22,
          props: { text: '02', fontFamily: 'Inter', fontSize: 12, fontWeight: '500', letterSpacing: '0.1em', color: '#A8A29E' } },
        { id: 'm2-title', archetype: 'text', behavior: 'cellFit', parent: 'mod-2',
          x: 32, y: 88, w: 320, h: 32,
          props: { text: 'Cycles', fontFamily: 'Inter', fontSize: 22, fontWeight: '500', letterSpacing: '-0.01em', color: '#1C1917' } },
        { id: 'm2-body', archetype: 'text', behavior: 'cellFit', parent: 'mod-2', anchor: 'm2-title',
          x: 32, y: 16, w: 320, h: 100,
    ...
    },
    {
      ...
      layout: '4col',
      children: [
        { id: 'cf0-h', archetype: 'text', behavior: 'cellFit', cell: 0,
          x: 32, y: 80, w: 0, h: 0,
          props: { text: 'Compline', fontFamily: 'Inter', fontSize: 16, fontWeight: '500', color: '#1C1917' } },
        { id: 'cf0-blurb', archetype: 'text', behavior: 'cellFit', cell: 0, anchor: 'cf0-h',
          x: 32, y: 16, w: 0, h: 0,
  ...
  sections: [
    ...
    },
    {
      ...
      children: [
        ...
        { id: 'c92-num', archetype: 'text', behavior: 'cellFit', parent: 'card-92',
        ...
        { id: 'c92-body', archetype: 'text', behavior: 'cellFit', parent: 'card-92', anchor: 'c92-num',
        ...
        { id: 'c64-num', archetype: 'text', behavior: 'cellFit', parent: 'card-64',
        ...
        { id: 'c64-body', archetype: 'text', behavior: 'cellFit', parent: 'card-64', anchor: 'c64-num',
        ...
        { id: 'card-0', archetype: 'container', behavior: 'wrap',
          ...
          props: { background: '#27272A', borderColor: '#27272A', borderRadius: 14 } },
        { id: 'c0-num', archetype: 'text', behavior: 'cellFit', parent: 'card-0',
        ...
        { id: 'c0-body', archetype: 'text', behavior: 'cellFit', parent: 'card-0', anchor: 'c0-num',
          x: 24, y: 24, w: 192, h: 120,
    ...
    },
    {
      ...
      layout: '4col',
      children: [
        { id: 'pf-mark', archetype: 'text', behavior: 'cellFit', cell: 0,
          x: 32, y: 56, w: 0, h: 0,
          props: { text: 'Praktis \u00A9', fontFamily: 'Inter', fontSize: 15, fontWeight: '500', color: '#18181B' } },
        { id: 'pf-addr', archetype: 'text', behavior: 'cellFit', cell: 0, anchor: 'pf-mark',
          x: 32, y: 16, w: 0, h: 0,
          props: { text: 'Jl. Senopati, Jakarta\nID 12190', fontFamily: 'Inter', fontSize: 12, fontWeight: '400', lineHeight: '1.6', color: '#71717A' } },
        { id: 'pc1-h', archetype: 'text', behavior: 'cellFit', cell: 1,
          x: 32, y: 56, w: 0, h: 0,
          props: { text: 'Studio', fontFamily: 'Inter', fontSize: 11, fontWeight: '500', letterSpacing: '0.14em', color: '#18181B' } },
        { id: 'pc1-1', archetype: 'text', behavior: 'cellFit', cell: 1, anchor: 'pc1-h',
          x: 32, y: 24, w: 0, h: 0,
          props: { text: 'Work', fontFamily: 'Inter', fontSize: 13, fontWeight: '400', color: '#3F3F46' } },
        { id: 'pc1-2', archetype: 'text', behavior: 'cellFit', cell: 1, anchor: 'pc1-1',
          x: 32, y: 8, w: 0, h: 0,
          props: { text: 'About', fontFamily: 'Inter', fontSize: 13, fontWeight: '400', color: '#3F3F46' } },
        { id: 'pc1-3', archetype: 'text', behavior: 'cellFit', cell: 1, anchor: 'pc1-2',
          x: 32, y: 8, w: 0, h: 0,
          props: { text: 'Journal', fontFamily: 'Inter', fontSize: 13, fontWeight: '400', color: '#3F3F46' } },
        { id: 'pc2-h', archetype: 'text', behavior: 'cellFit', cell: 2,
          x: 32, y: 56, w: 0, h: 0,
          props: { text: 'Social', fontFamily: 'Inter', fontSize: 11, fontWeight: '500', letterSpacing: '0.14em', color: '#18181B' } },
        { id: 'pc2-1', archetype: 'text', behavior: 'cellFit', cell: 2, anchor: 'pc2-h',
          x: 32, y: 24, w: 0, h: 0,
          props: { text: 'Instagram', fontFamily: 'Inter', fontSize: 13, fontWeight: '400', color: '#3F3F46' } },
        { id: 'pc2-2', archetype: 'text', behavior: 'cellFit', cell: 2, anchor: 'pc2-1',
          x: 32, y: 8, w: 0, h: 0,
          props: { text: 'Are.na', fontFamily: 'Inter', fontSize: 13, fontWeight: '400', color: '#3F3F46' } },
        { id: 'pc3-h', archetype: 'text', behavior: 'cellFit', cell: 3,
          x: 32, y: 56, w: 0, h: 0,
          props: { text: 'Contact', fontFamily: 'Inter', fontSize: 11, fontWeight: '500', letterSpacing: '0.14em', color: '#18181B' } },
        { id: 'pc3-1', archetype: 'text', behavior: 'cellFit', cell: 3, anchor: 'pc3-h',
          x: 32, y: 24, w: 0, h: 0,
...
const LAYOUT_E04 = {
  ...
  sections: [
    ...
    },
    {
      ...
      layout: 'asym',
      children: [
        { id: 'firm-headline', archetype: 'text', behavior: 'cellFit', cell: 0,
          x: 96, y: 88, w: 0, h: 0,
        ...
        { id: 'firm-sub', archetype: 'text', behavior: 'cellFit', cell: 0, anchor: 'firm-headline',
          x: 96, y: 32, w: 0, h: 0,
        ...
        { id: 'cell-pillar-1', archetype: 'container', behavior: 'cellFit', cell: 1,
        ...
        { id: 'p1-title', archetype: 'text', behavior: 'cellFit', parent: 'cell-pillar-1', anchor: 'p1-icon',
          x: 0, y: 24, w: 280, h: 22,
          props: { text: 'BIG MEDIA', fontFamily: 'Inter', fontSize: 12, fontWeight: '500', letterSpacing: '0.16em', color: '#18181B' } },
        { id: 'p1-body', archetype: 'text', behavior: 'cellFit', parent: 'cell-pillar-1', anchor: 'p1-title',
          x: 0, y: 16, w: 280, h: 96,
        ...
        { id: 'cell-pillar-2', archetype: 'container', behavior: 'cellFit', cell: 1,
          x: 360, y: 88, w: 320, h: 240,
          props: { background: 'rgba(0,0,0,0)', borderColor: 'rgba(0,0,0,0)', borderRadius: 0 } },
        { id: 'p2-icon', archetype: 'container', behavior: 'fixed', parent: 'cell-pillar-2',
          x: 0, y: 0, w: 36, h: 24,
          props: { background: 'rgba(0,0,0,0)', borderColor: '#27272A', borderRadius: 999 } },
        { id: 'p2-title', archetype: 'text', behavior: 'cellFit', parent: 'cell-pillar-2', anchor: 'p2-icon',
          x: 0, y: 24, w: 280, h: 22,
          props: { text: 'PUBLICATIONS', fontFamily: 'Inter', fontSize: 12, fontWeight: '500', letterSpacing: '0.16em', color: '#18181B' } },
        { id: 'p2-body', archetype: 'text', behavior: 'cellFit', parent: 'cell-pillar-2', anchor: 'p2-title',
          x: 0, y: 16, w: 280, h: 96,
        ...
        { id: 'cell-pillar-3', archetype: 'container', behavior: 'cellFit', cell: 1, anchor: 'cell-pillar-1',
          x: 24, y: 48, w: 320, h: 240,
          props: { background: 'rgba(0,0,0,0)', borderColor: 'rgba(0,0,0,0)', borderRadius: 0 } },
        { id: 'p3-icon', archetype: 'container', behavior: 'fixed', parent: 'cell-pillar-3',
          x: 0, y: 0, w: 36, h: 24,
          props: { background: 'rgba(0,0,0,0)', borderColor: '#27272A', borderRadius: 999 } },
        { id: 'p3-title', archetype: 'text', behavior: 'cellFit', parent: 'cell-pillar-3', anchor: 'p3-icon',
          x: 0, y: 24, w: 280, h: 22,
          props: { text: 'GUIDES & REPORTS', fontFamily: 'Inter', fontSize: 12, fontWeight: '500', letterSpacing: '0.16em', color: '#18181B' } },
        { id: 'p3-body', archetype: 'text', behavior: 'cellFit', parent: 'cell-pillar-3', anchor: 'p3-title',
          x: 0, y: 16, w: 280, h: 96,
        ...
        { id: 'cell-pillar-4', archetype: 'container', behavior: 'cellFit', cell: 1, anchor: 'cell-pillar-2',
          x: 360, y: 48, w: 320, h: 240,
          props: { background: 'rgba(0,0,0,0)', borderColor: 'rgba(0,0,0,0)', borderRadius: 0 } },
        { id: 'p4-icon', archetype: 'container', behavior: 'fixed', parent: 'cell-pillar-4',
          x: 0, y: 0, w: 36, h: 24,
          props: { background: 'rgba(0,0,0,0)', borderColor: '#27272A', borderRadius: 999 } },
        { id: 'p4-title', archetype: 'text', behavior: 'cellFit', parent: 'cell-pillar-4', anchor: 'p4-icon',
          x: 0, y: 24, w: 280, h: 22,
          props: { text: 'MILLION DOLLAR HOUSE', fontFamily: 'Inter', fontSize: 12, fontWeight: '500', letterSpacing: '0.16em', color: '#18181B' } },
        { id: 'p4-body', archetype: 'text', behavior: 'cellFit', parent: 'cell-pillar-4', anchor: 'p4-title',
          x: 0, y: 16, w: 280, h: 96,
        ...
        { id: 'p4-watch', archetype: 'text', behavior: 'cellFit', parent: 'cell-pillar-4', anchor: 'p4-body',
          x: 0, y: 16, w: 200, h: 18,
  ...
  sections: [
    ...
    },
    {
      ...
      children: [
        ...
        { id: 'asym-cont', archetype: 'text', behavior: 'cellFit', cell: 1, anchor: 'asym-long',
          x: 24, y: 32, w: 0, h: 0,
    ...
    },
    {
      ...
      children: [
        ...
        { id: 'mix-card-1', archetype: 'container', behavior: 'cellFit', cell: 1,
          x: 24, y: 80, w: 336, h: 440,
          props: { background: '#FAFAFA', borderColor: '#E4E4E7', borderRadius: 4 } },
        { id: 'mix-1-num', archetype: 'text', behavior: 'cellFit', parent: 'mix-card-1',
          x: 28, y: 28, w: 280, h: 24,
          props: { text: '01', fontFamily: 'IBM Plex Serif', fontSize: 18, fontWeight: '400', color: '#A1A1AA' } },
        { id: 'mix-1-title', archetype: 'text', behavior: 'cellFit', parent: 'mix-card-1', anchor: 'mix-1-num',
        ...
        { id: 'mix-1-inner', archetype: 'container', behavior: 'cellFit', parent: 'mix-card-1', anchor: 'mix-1-title',
          x: 28, y: 24, w: 280, h: 200,
          props: { background: '#FFFFFF', borderColor: '#E4E4E7', borderRadius: 4 } },
        { id: 'mix-1-inner-label', archetype: 'text', behavior: 'cellFit', parent: 'mix-1-inner',
        ...
        { id: 'mix-1-inner-body', archetype: 'text', behavior: 'cellFit', parent: 'mix-1-inner', anchor: 'mix-1-inner-label',
        ...
        { id: 'mix-card-2', archetype: 'container', behavior: 'cellFit', cell: 2,
          x: 24, y: 80, w: 336, h: 200,
          props: { background: '#FAFAFA', borderColor: '#E4E4E7', borderRadius: 4 } },
        { id: 'mix-2-num', archetype: 'text', behavior: 'cellFit', parent: 'mix-card-2',
          x: 28, y: 28, w: 280, h: 22,
          props: { text: '02', fontFamily: 'IBM Plex Serif', fontSize: 18, fontWeight: '400', color: '#A1A1AA' } },
        { id: 'mix-2-title', archetype: 'text', behavior: 'cellFit', parent: 'mix-card-2', anchor: 'mix-2-num',
          x: 28, y: 12, w: 280, h: 32,
          props: { text: 'Hug text re-flows', fontFamily: 'IBM Plex Serif', fontSize: 22, fontWeight: '400', color: '#18181B' } },
        { id: 'mix-2-body', archetype: 'text', behavior: 'cellFit', parent: 'mix-card-2', anchor: 'mix-2-title',
        ...
        { id: 'mix-card-3', archetype: 'container', behavior: 'cellFit', cell: 2, anchor: 'mix-card-2',
          x: 24, y: 24, w: 336, h: 216,
          props: { background: '#18181B', borderColor: '#18181B', borderRadius: 4 } },
        { id: 'mix-3-num', archetype: 'text', behavior: 'cellFit', parent: 'mix-card-3',
          x: 28, y: 28, w: 280, h: 22,
          props: { text: '03', fontFamily: 'IBM Plex Serif', fontSize: 18, fontWeight: '400', color: '#71717A' } },
        { id: 'mix-3-title', archetype: 'text', behavior: 'cellFit', parent: 'mix-card-3', anchor: 'mix-3-num',
          x: 28, y: 12, w: 280, h: 32,
          props: { text: 'Deep anchor chain', fontFamily: 'IBM Plex Serif', fontSize: 22, fontWeight: '400', color: '#FAFAFA' } },
        { id: 'mix-3-l1', archetype: 'text', behavior: 'cellFit', parent: 'mix-card-3', anchor: 'mix-3-title',
          x: 28, y: 16, w: 280, h: 22,
          props: { text: '\u21B3 first link', fontFamily: 'Inter', fontSize: 12, fontWeight: '400', color: '#A1A1AA' } },
        { id: 'mix-3-l2', archetype: 'text', behavior: 'cellFit', parent: 'mix-card-3', anchor: 'mix-3-l1',
          x: 28, y: 8, w: 280, h: 22,
          props: { text: '\u21B3 second link', fontFamily: 'Inter', fontSize: 12, fontWeight: '400', color: '#A1A1AA' } },
        { id: 'mix-3-l3', archetype: 'text', behavior: 'cellFit', parent: 'mix-card-3', anchor: 'mix-3-l2',
          x: 28, y: 8, w: 280, h: 22,
    ...
    },
    {
      ...
      layout: '4col',
      children: [
        { id: 'ag-mark', archetype: 'text', behavior: 'cellFit', cell: 0,
          x: 32, y: 56, w: 0, h: 0,
          props: { text: 'Atelier Grid', fontFamily: 'IBM Plex Serif', fontSize: 16, fontWeight: '500', color: '#18181B' } },
        { id: 'ag-blurb', archetype: 'text', behavior: 'cellFit', cell: 0, anchor: 'ag-mark',
          x: 32, y: 16, w: 0, h: 0,
